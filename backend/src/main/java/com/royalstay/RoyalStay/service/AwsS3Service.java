...
public class AwsS3Service {
    ...
    private final String bucketName = "phegon-hotel-images-hi";
    ...
    private final String awsS3AccessKey = "AKIAQKGGXCUQFK4SZCHW";
    private final String awsS3SecretKey = "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";
